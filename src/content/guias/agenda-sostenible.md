...
Si el objetivo es la sostenibilidad, en algún momento la palanca tiene que ser otra, y casi siempre es el [honorario](/guias/honorarios-diferenciados). Cobrar un poco mejor permite atender a menos personas, descansar más y mantener la calidad del trabajo. No es una cuestión de codicia: es la aritmética que cierra a largo plazo.
